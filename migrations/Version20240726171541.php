 ...
 */
final class Version20240726171541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE the_book (id INT AUTO_INCREMENT NOT NULL, google_books_id VARCHAR(255) NOT NULL, title LONGTEXT NOT NULL, subtitle LONGTEXT DEFAULT NULL, publish_date DATETIME DEFAULT NULL, description LONGTEXT DEFAULT NULL, isbn10 VARCHAR(255) DEFAULT NULL, isbn13 VARCHAR(255) DEFAULT NULL, page_count INT DEFAULT NULL, small_thumbnail LONGTEXT DEFAULT NULL, thumbnail LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE the_book_book_author (the_book_id INT NOT NULL, book_author_id INT NOT NULL, INDEX IDX_49471DD2F6709D67 (the_book_id), INDEX IDX_49471DD2E4DBE55D (book_author_id), PRIMARY KEY(the_book_id, book_author_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE the_book_book_author ADD CONSTRAINT FK_49471DD2F6709D67 FOREIGN KEY (the_book_id) REFERENCES the_book (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE the_book_book_author ADD CONSTRAINT FK_49471DD2E4DBE55D FOREIGN KEY (book_author_id) REFERENCES book_author (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE the_book_book_author DROP FOREIGN KEY FK_49471DD2F6709D67');
        $this->addSql('ALTER TABLE the_book_book_author DROP FOREIGN KEY FK_49471DD2E4DBE55D');
        ...
        $this->addSql('DROP TABLE the_book_book_author');
